...
if( !class_exists('Ws247_M_WG') ){
	...
	class Ws247_M_WG{
		...
		function __construct() {
			...
			$this->js_lib_url = get_stylesheet_directory(self::get_current_dir().'/widget_helper/assets/js');
			$this->css_lib_url = get_stylesheet_directory(self::get_current_dir().'/widget_helper/assets/css');
		...
		static function get_current_dir(){
			$arr_ = explode(basename(get_stylesheet_directory()), WPSHARE247_WG_DIR);
