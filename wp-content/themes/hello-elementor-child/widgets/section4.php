<?php
class section4 extends WP_Widget {
	function __construct() {
		$widget_ops = [ 
			'classname' => 'services-section',
			'description' => esc_html__( 'Section 4 hiển thị trên trang chủ', 'hello-elementor' ),
			'customize_selective_refresh' => true
		];
		parent::__construct(
			'service_in_section3_home',
			esc_html__( '* Section 4 trang chủ', 'hello-elementor' ),
			$widget_ops
		);
	}
